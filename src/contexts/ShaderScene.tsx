...
type ShaderSceneContextType = {
  ...
  setShader: (shader: p5Types.Shader) => void;
};

export const ShaderSceneContext = createContext({} as ShaderSceneContextType);

export const ShaderSceneContextProvider = ({
  children,
}: {
  children: ReactNode;
}) => {
...
export const useShaderSceneContext = () => useContext(ShaderSceneContext);
