...
with open('sphere_3d_engine/__init__.py', 'r') as f:
    for line in f:
...
kwargs = {
    'name': 'sphere_3d_engine',
    'version': version,
    'description': '',
    'long_description': readme,
    'author': 'Pablo Alessandro Santos Hugen',
    'author_email': 'pablohuggem@gmail.com',
    'maintainer': 'Pablo Alessandro Santos Hugen',
    'maintainer_email': 'pablohuggem@gmail.com',
    'url': 'https://github.com/_/sphere_3d_engine',
    'license': 'MIT',
    'classifiers': [
